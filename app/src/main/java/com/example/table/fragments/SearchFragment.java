...
public class SearchFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button buttonzap1 = (Button) view.findViewById(R.id.zapisatsya_Button_cardOfevent_1);
        buttonzap1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(@NonNull View view) {
                //Если getTag() от R.id.zapisatsya_Button_cardOfevent_1 не пустой, то в нем id мероприятия
                //Добавить функцию для вывода мероприятия
            }
        });
        Button buttonzap2 = (Button) view.findViewById(R.id.zapisatsya_Button_cardOfevent_2);
        buttonzap2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(@NonNull View view) {
                //Добавить функцию для вывода мероприятия
            }
